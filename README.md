...
- **You can see author´s books collection**
- **You can leave a comment**
- **You can like the book**

<p align="right">(<a href="#readme-top">back to top</a>)</p>

## 🚀 Live Demo <a name="live-demo"></a>

- [Live Demo Link](https://shm04.github.io/javascript-capstone/dist)
...
```
  cd my-folder
  git clone git@github.com:myaccount/javascript-capstone.git 
```
...
- GitHub: [@sylvester-wamaya](https://github.com/sylvester-wamaya)
- LinkedIn: [Sylvester Wamaya](https://www.linkedin.com/in/sylvester-wamaya-b11a93112/)
